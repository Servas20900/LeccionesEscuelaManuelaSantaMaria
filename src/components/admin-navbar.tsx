...
export function AdminNavbar({ currentPath = "/admin" }: AdminNavbarProps) {
  return (
    <header className="glass-panel rounded-2xl border border-slate-200/80 px-2 py-2 sm:px-6 sm:py-3 sm:rounded-[1.6rem]">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav className="flex items-center gap-1 sm:gap-1 text-xs sm:text-sm font-medium flex-wrap">
          ...
          <div className="inline-flex items-center justify-center gap-1 rounded-lg border border-slate-800/70 bg-slate-900 text-slate-100 h-9 w-9 sm:h-9 sm:w-auto sm:gap-2 sm:rounded-xl sm:px-3 sm:py-2 flex-shrink-0" title="Zona segura">
